...
#keys = list(set(dfpehno.loc[:,VARIABLE]))
...
print("Writing confusion matrix to file: ",CONFUSIONMATRIXFILE)
cnfMX.to_csv(DATAOUTPUT+CONFUSIONMATRIXFILE)
 """
